...
renderAreaSpots  :: (PlotValue z) => AreaSpots z x y -> PointMapFn x y -> CBProgram ()
...
renderSpotLegend :: AreaSpots z x y -> Rect -> CBProgram ()
...
renderAreaSpots4D  :: (PlotValue z, PlotValue t, Show t) =>
                      AreaSpots4D z t x y -> PointMapFn x y -> CBProgram ()
...
renderSpotLegend4D :: AreaSpots4D z t x y -> Rect -> CBProgram ()
